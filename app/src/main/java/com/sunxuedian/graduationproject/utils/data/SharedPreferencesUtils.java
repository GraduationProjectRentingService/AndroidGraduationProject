...
public class SharedPreferencesUtils {
    ...
    private static MyLog logger = LoggerFactory.getLogger(SharedPreferencesUtils.class);
    ...
    private static boolean saveObject(Context context, String key, Object value){
        if (context == null){
            logger.e("the context can't be null!");
            return false;
        }

        if (TextUtils.isEmpty(key)){
            logger.e("the key can't be null or empty!");
            return false;
        }
